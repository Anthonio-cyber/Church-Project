...
| Document | For |
|---|---|
| [docs/RENDER.md](docs/RENDER.md) | **Step-by-step deployment to Render at rcnipastor.com** |
...
| [docs/DOMAIN.md](docs/DOMAIN.md) | **Buying rcnipastor.com and pointing the platform at it** |
